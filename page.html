    ...
    <div class="col-md-offset-1 col-md-10">
      <div class="row">
        <div class="col-md-12 mb90 mt30 animated-links">
          <a href="/">Retour</a>
          <a href="articles.html" class="float-right">#mesarticles</a>
        </div>

        <div class="col-md-12 mt30">
          <div class="row row-eq-height mb90">
            <div class="col-sm-5">
              <img src="img/avatar.jpg" class="img-circle img-thumbnail img-responsive center-block centered mb30"/>
            </div>
            <div class="col-sm-7">
              <h1 class="title-page">Configurer Laravel en local sur sa machine</h1>
              <a href="#">#Voyages</a>
            </div>
          </div>
        </div>
