	...
	<div class="container">
		<div class="col-md-12">
			...
			<div id="content_row" class="row">
				...
				@else
					<div class="col-lg-12">
						<p class="content">Aucune catégorie d'articles actuellement.</p>
					</div>
				@endif
			</div>
		</div>
	...
	<script>
		$(document).ready(function(){
			var datatable = $('#table').DataTable({
				...
				oLanguage: {
					"sZeroRecords": "Aucune catégorie d'articles trouvée.",
					"sEmptyTable": "Aucune catégorie d'articles actuellement."
				},
				"sDom": '<"H">t<"F"p>'
			});
