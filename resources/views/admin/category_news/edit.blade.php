...
@include('admin._menu')
	...
	<div class="container">
		<div class="col-md-12">
			...
			@endif
			<div class="row">
				<form action="{{ route('admin.category_news.update', $category->id) }}" method="post" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="content text-center">
									<div class="col-lg-12">
										<div id="imagePreview" class="img-circle imagePreview" style="background-image: url('{{ route("category_news_image_small", [$category->id, "original"]) }}')">
											@if($category->has_image == 1)
					...
					<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
						...
						@include('admin.category_news._form')
